...
{	
		...
		public void actionPerformed(ActionEvent ae) {
		  ...
		  if(o == open)
			  Singleton.getInstance().openImage();
		  else if(o == embed)
		     embedMessage();
		  else if(o == save) 
		     saveImage();
		...
		protected java.io.File showFileDialog(final boolean open) {
     ...
     public  String getDescription() {
	  ...
	  fc.addChoosableFileFilter(ff);
		...
		//openImage method Here
		

		private void embedMessage() {
		  String mess = message.getText();
		  embeddedImage =  Singleton.getInstance().sourceImage.getSubimage(0,0, Singleton.getInstance().sourceImage.getWidth(), Singleton.getInstance().sourceImage.getHeight());
//***************************************************************		  
...
//			System.out.println(imageSize);
		...
		private void resetInterface() {
		  ...
		  Singleton.getInstance().sourceImage = null;
		  embeddedImage = null;
		  sp.setDividerLocation(0.5);
		  this.validate();
  }
